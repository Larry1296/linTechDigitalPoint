...
class Store(TimeStamped):
    name=models.CharField(max_length=160); currency=models.CharField(max_length=3,default="KES"); timezone=models.CharField(max_length=50,default="Africa/Nairobi"); measurement_unit=models.CharField(max_length=10,default="cm"); phone=models.CharField(max_length=30,blank=True); email=models.EmailField(blank=True); address=models.TextField(blank=True); receipt_footer=models.CharField(max_length=255,blank=True); reservation_timeout_minutes=models.PositiveIntegerField(default=30)

...
class Product(TimeStamped):
    ...
    name=models.CharField(max_length=180); slug=models.SlugField(unique=True); category=models.ForeignKey(Category,on_delete=models.PROTECT); brand=models.ForeignKey(Brand,null=True,blank=True,on_delete=models.PROTECT); product_type=models.CharField(max_length=20,choices=[(STOCK_ITEM,"Stock item"),(SERVICE,"Service")],default=STOCK_ITEM); description=models.TextField(blank=True); active=models.BooleanField(default=True); ecommerce_visible=models.BooleanField(default=True)
    def __str__(self): return self.name
